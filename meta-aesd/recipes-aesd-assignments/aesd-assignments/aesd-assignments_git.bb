...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-georgehodgkins.git;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
get_tip () { 
	git ls-remote $(echo $1 | cut -f1 --delimiter=;) $2 | cut -f1
}
...
FILES:${PN} += "${bindir}/aesdsocket ${sysconfdir}/init.d ${systemd_unitdir}/aesdsocket.service"
...
do_install () {
	...
	install -m 0744 ${S}/aesdsocket-start-stop ${D}${sysconfdir}/rc5.d/S99aesdsocket
